<h2><a href="https://etcd.io/docs/v3.5/op-guide/configuration/#configuration-file">Follow the Documentation for more Details</a></h2>
### Set the SERVER_IP variable
SERVER_IP = <IP-ADDR-Server>
...
### Step2: Configure the etcd.config file
...
### Step3: Create the Cert with the CSR Token Generated
```sh
...
### Step4: Copy the Certificate and Key to /etc/etcd
...
### Step 5: Copy the ETCD and ETCDCTL Binaries to the Path to make it accessible through the cli
